 ...
 *
 */
public class FileIndexPreferences {
    List<String> defaultSearchDirectoryNames = new ArrayList<String>();
    List<String> defaultExcludeDirectoryNames = new ArrayList<String>();
    ...
    /**
     * @return the defaultExcludeDirectoryNames
     */
    public List<String> getDefaultExcludeDirectoryNames() {
        return defaultExcludeDirectoryNames;
    }

    /**
     * @param defaultExcludeDirectoryNames
     *            the defaultExcludeDirectoryNames to set
     */
    public void setDefaultExcludeDirectoryNames(List<String> defaultExcludeDirectoryNames) {
        this.defaultExcludeDirectoryNames = defaultExcludeDirectoryNames;
    }
