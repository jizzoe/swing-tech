    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Results for search term 'Blaka'</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  <td><a href="file:///C:\temp\software-engineering-radio\SE-Radio-Episode-221-Jez-Humble-on-Continuous-Delivery.mp3">game-image-1.jpg</a></td>
                  <td>C:\git\swingtech\swing-tech\sandbox\honor-system-game\1.0.0\src\main\webapp\images\game-image-1.jpg</td>
                </tr>
                <tr>
                  <td>index_uuid</td>
                  <td>C:\git\swingtech\swing-tech\pragthink\dev-environment\.vagrant\machines\default\virtualbox\index_uuid</td>
                </tr>
                <tr>
                  <td>index.html</td>
                  <td>C:\git\swingtech\swing-tech\sandbox\cheebie-jenkins-rip\1.0.0\src\main\webapp\index.html</td>
                </tr>
              </tbody>
            </table>
          </div>
