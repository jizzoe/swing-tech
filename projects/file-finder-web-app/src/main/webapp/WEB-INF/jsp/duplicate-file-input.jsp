    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div>
          	<h2 class="sub-header">Find Duplicates</h2>
          	<form action="/find-duplicates">
	          	<b>Search Directories</b>
	          	<input name="searchDirectories" class="form-control" placeholder="Type in File Directory to Search..." value="c:\Joe" type="text"/>
	          	<input name="searchDirectories" class="form-control" placeholder="Type in File Directory to Search..." value="c:\Joe" type="text"/>
